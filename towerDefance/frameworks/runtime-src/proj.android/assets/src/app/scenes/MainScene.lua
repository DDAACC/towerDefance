...
function MainScene:ctor()
    ...
    buildControl.new(1):addTo(self.title):pos(780,110)
    buildControl.new(2):addTo(self.title):pos(830,110)
    buildControl.new(3):addTo(self.title):pos(880,110)
    buildControl.new(4):addTo(self.title):pos(780,60)
    buildControl.new(5):addTo(self.title):pos(830,60)
    buildControl.new(6):addTo(self.title):pos(880,60)
...
function MainScene:GameInit()--游戏初始化
   ...
   for i=1,#data_towerbase do
      ...
      self.towerbase[i]=towerbase.new(i):addTo(self.bg):pos(data_towerbase[i][1],data_towerbase[i][2])
